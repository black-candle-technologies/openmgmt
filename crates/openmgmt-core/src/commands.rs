use crate::{
    db::{Database, Result},
    models::{
        BoardState, CalendarBlock, GptActionLog, NewGptActionLog, NewOrganization, NewProject,
        ...
        ScheduledBlockCompletion, ScoringSettings, ScoringSettingsPatch, Task, TaskPatch,
